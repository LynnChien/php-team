        ...
        ORDER BY `paymentTypeId` ASC";
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <button class="btn btn-outline-dark" type="submit" name="smb_delete">刪除</button>
                            </td>
                        </tr>
            </form>
            ...
            <form name="myForm" method="POST" action="./insertPaymentType.php" enctype="multipart/form-data">
                <table class="border table table-hover">
                    ...
                    <tfoot>
                        <tr>
                            <td class="border" colspan="2"><button class="btn btn-outline-dark" type="submit" name="smb_add">新增</button></td>
                        </tr>
                    </tfoot>
                </table>
